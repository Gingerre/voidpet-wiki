...
## Gameplay Uses
Currently, there are no quests or gameplay requirements that have been implemented that demand the player to catch a vivid.
...
## NPC Vivids
King is the first, and so far only, NPC pet that is vivid. King is a Lvl 4 Celestial Estrangement that can be found in Horto east. King's trainer is unknown.
