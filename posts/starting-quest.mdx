...
description: 'The first activity in the game, grouped together as a quest for brevity.'
keywords: ["quest", "zeroth"]
sidebar: { type: 'quest', name: 'starting-quest', length: 'long', location: "Garden of Consiousness & The Institute", starterNPC: "Tilde", reward: "None", requirements: "None" }
category: 'quests'
---

*Unfinished*
###### I've done about half of this, but we need to finish transcribing. I'll-
